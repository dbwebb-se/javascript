(function () {
    ...
    function helloWorld() {
        ...
        window.alert("Hello World from a JavaScript function showing an alert.");
    }
    ...
    function helloMyNumber() {
        ...
        var matched;
        var max = 42;
        var yourLuckyNumber = window.prompt("So, whats your lucky number today (enter a number between 1 and " + max + ")?");
